...
Public Class RPT_MP_Form
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "boxtree.RPT_MP_Form.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_mp_pk() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_trx_type() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_MP_Form
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_MP_Form = New RPT_MP_Form()
        rpt.Site = Me.Site
        Return rpt
    End Function
