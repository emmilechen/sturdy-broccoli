...
Public Class RPT_Induction_Form
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "boxtree.RPT_Induction_Form.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_sind_no() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Induction_Form
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Induction_Form = New RPT_Induction_Form()
        rpt.Site = Me.Site
        Return rpt
    End Function
