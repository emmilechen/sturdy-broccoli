...
Public Class rptSlsTransaction
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        strSQL = "exec RPT_Sls_Transaction_Report '" & OrderNo & "', '" & IncomingNo & "', '" & InvoiceNo & "', '" & PaymentNo & "' "
        ...
        Dim filter As String = filterOrderNo + vbCrLf + filterIncomingNo + vbCrLf + filterInvoiceNo + vbCrLf + filterPaymentNo
