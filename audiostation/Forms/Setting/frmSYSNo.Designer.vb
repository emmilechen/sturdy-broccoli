...
Partial Class frmSYSNo
    ...
    Private Sub InitializeComponent()
        ...
        Me.ntbTrxNo = New boxtree.NumericTextBox()
        Me.ntbTrxDigit = New boxtree.NumericTextBox()
    ...
    Friend WithEvents ntbTrxDigit As boxtree.NumericTextBox
    Friend WithEvents ntbTrxNo As boxtree.NumericTextBox
