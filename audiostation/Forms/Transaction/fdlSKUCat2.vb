...
Public Class fdlSKUCat2
    ...
    Private Sub fdlSKUCat2_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        Select Case m_FrmCallerId
            Case "frmSKUCategorySub"
                With frmSKUCategorySub
                    .CategoryId = LeftSplitUF(ListView1.SelectedItems.Item(0).Tag)
                    .CategoryCode = ListView1.SelectedItems.Item(0).SubItems.Item(0).Text
                End With
        End Select
        Me.Close()
    End Sub
