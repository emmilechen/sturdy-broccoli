...
Partial Class frmStockAdj
    ...
    Private Sub InitializeComponent()
        ...
        Me.ntbStockAdjCost = New boxtree.NumericTextBox()
        Me.ntbStockAdjQty = New boxtree.NumericTextBox()
    ...
    Friend WithEvents ntbStockAdjQty As boxtree.NumericTextBox
    Friend WithEvents ntbStockAdjCost As boxtree.NumericTextBox
