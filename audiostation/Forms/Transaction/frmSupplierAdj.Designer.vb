...
Partial Class frmSupplierAdj
    ...
    Private Sub InitializeComponent()
        ...
        Me.ntbLocalAmount = New boxtree.NumericTextBox()
        Me.ntbAmount = New boxtree.NumericTextBox()
    ...
    Friend WithEvents ntbAmount As boxtree.NumericTextBox
    Friend WithEvents ntbLocalAmount As boxtree.NumericTextBox
