...
Partial Class frmPPitchingApprovalList
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label6.Text = "Purchase Pitching Approval"
        '
        'Label4
        '
        ...
        Me.Label2.Text = "Purchase Pitching No."
        '
        'Label3
        '
        ...
        Me.Name = "frmPPitchingApprovalList"
        Me.ShowIcon = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Purchase Pitching Approval List"
