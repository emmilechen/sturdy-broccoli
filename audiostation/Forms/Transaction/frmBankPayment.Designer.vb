...
Partial Class frmBankPayment
    ...
    Private Sub InitializeComponent()
        ...
        Me.ntbBankTransTaxPercent = New boxtree.NumericTextBox()
        Me.ntbBankTransAmount = New boxtree.NumericTextBox()
        Me.ntbRate = New boxtree.NumericTextBox()
    ...
    Friend WithEvents ntbBankTransAmount As boxtree.NumericTextBox
    Friend WithEvents ntbRate As boxtree.NumericTextBox
    ...
    Friend WithEvents ntbBankTransTaxPercent As boxtree.NumericTextBox
