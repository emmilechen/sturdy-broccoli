...
Partial Class frmJournal
    ...
    Private Sub InitializeComponent()
        ...
        Me.ntbLocalCR = New boxtree.NumericTextBox()
        Me.ntbLocalDB = New boxtree.NumericTextBox()
        Me.ntbCRValue = New boxtree.NumericTextBox()
        Me.ntbJournalCurrRate = New boxtree.NumericTextBox()
        Me.ntbDBValue = New boxtree.NumericTextBox()
        Me.SuspendLayout()
        '
        'txtJournalNo
        '
    ...
    Friend WithEvents ntbDBValue As boxtree.NumericTextBox
    ...
    Friend WithEvents ntbJournalCurrRate As boxtree.NumericTextBox
    ...
    Friend WithEvents ntbCRValue As boxtree.NumericTextBox
    ...
    Friend WithEvents ntbLocalCR As boxtree.NumericTextBox
    Friend WithEvents Label9 As System.Windows.Forms.Label
    Friend WithEvents ntbLocalDB As boxtree.NumericTextBox
