...
Partial Class frmBC
    ...
    Private Sub InitializeComponent()
        ...
        Me.ntbBCCurrRate = New boxtree.NumericTextBox()
        Me.ntbBCDtlPrice = New boxtree.NumericTextBox()
        Me.ntbSDeliveryQty = New boxtree.NumericTextBox()
    ...
    Friend WithEvents ntbSDeliveryQty As boxtree.NumericTextBox
    Friend WithEvents ntbBCDtlPrice As boxtree.NumericTextBox
    ...
    Friend WithEvents ntbBCCurrRate As boxtree.NumericTextBox
