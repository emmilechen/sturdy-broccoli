...
Public Class frmSQuote
    ...
    Sub lock_obj(ByVal isLock As Boolean)
        ...
        btnConvertToSO.Visible = False

        Select Case m_FrmCallerId
            Case "frmSQuoteList"
                'btnVoid.Visible = True
            Case "frmSQuoteApprovalList"
        ...
        Select Case m_SOStatus
            Case "D" 'Draft
                btnEdit.Enabled = isLock
                btnSubmitApproval.Visible = True
            Case "W" 'Waiting for Approval
                If m_FrmCallerId = "frmSQuoteApprovalList" Then btnEdit.Enabled = isLock
            Case "A" 'Approved
                If m_SONo = "" Then
                    btnConvertToSO.Visible = True
                    btnConvertToSO.Enabled = isLock
                End If
            Case "R" 'Revised
                btnEdit.Enabled = isLock
                btnSubmitApproval.Visible = True
    ...
    Private Sub btnSaveD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveD.Click
        Try
            ...
            If cmbSODtlType.Items(cmbSODtlType.SelectedIndex).ItemData = "S" And m_SKUId = 0 Then
                MsgBox("Stock are primary fields that should be entered. Please select before you save it.", vbCritical + vbOKOnly, Me.Text)
                txtSODtlDesc.Focus()
                Exit Sub
            End If
    ...
    Private Sub btnCloseSO_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnInvoiceNo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            If m_CId = 0 Or m_SlsCodeId = 0 Then
                MsgBox("Sales Code, Customer Code and Customer Name are primary fields that should be entered. Please enter those fields before you save it.", vbCritical + vbOKOnly, Me.Text)
                txtCCode.Focus()
    ...
    Private Sub btnConvertToSO_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConvertToSO.Click
        isConvertToSO = True
        btnSave_Click(sender, e)
        UpdSysNumber("sord")
        isConvertToSO = False

        Dim frm1 As New frmSO
        With frm1
            .SOId = m_SOId
            .MdiParent = frmMAIN
