...
Partial Class frmPPitching
    ...
    Friend WithEvents ntbPOQty As boxtree.NumericTextBox
    Friend WithEvents ntbPOPrice As boxtree.NumericTextBox
    ...
    Friend WithEvents ntbPOTaxPercent As boxtree.NumericTextBox
    ...
    Friend WithEvents ntbPOCurrRate As boxtree.NumericTextBox
